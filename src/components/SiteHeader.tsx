...
export function SiteHeader({ activePage }: SiteHeaderProps) {
  ...
  return (
    <header className="site-header">
      <button className="site-logo-btn" onClick={() => navigateTo('/')} aria-label="Home">
      ...
      <div className="site-menu-wrap" ref={menuRef}>
        <button
        ...
        {menuOpen && (
          <div className="site-menu-dropdown">
            ...
            <div className="site-menu-item site-menu-item--disabled">
              Update Notes
            </div>
          </div>
        )}
